...
function TriggerIcon({ as, className, ...rest }) {
  ...
  (
    ...
    <SelectPrimitives.Portal>
      <SelectPrimitives.Content
        ...
        className={cnExt(
          // base
          "relative z-50 overflow-hidden rounded-2xl bg-bg-white-0 shadow-regular-md ring-1 ring-inset ring-stroke-soft-200", // widths
          "min-w-[--radix-select-trigger-width] max-w-[max(var(--radix-select-trigger-width),320px)]", // heights
          "max-h-[--radix-select-content-available-height]", // animation
    ...
    return (
      <SelectPrimitives.Item
        ...
        className={cnExt(
          ...
          "flex items-center gap-2 transition duration-200 ease-out", // disabled
          "data-[disabled]:pointer-events-none data-[disabled]:text-text-disabled-300", // hover, focus
      ...
      >
        <SelectPrimitives.ItemText asChild>
          <span
            className={cnExt(
              // base
              "flex flex-1 items-center gap-2", // disabled
...
function SelectItemIcon({ as, className, ...rest }) {
